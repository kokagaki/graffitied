...
- (void)loadView
{
    ...
    self.backButton.frame = CGRectMake(viewSize.width - backButtonSize.width - 30,
                                       viewSize.height - backButtonSize.height - 140,
    ...
    self.colorButton.frame = CGRectMake(viewSize.width - buttonSize.width - 10,
                                        viewSize.height - buttonSize.height - 95,
                                        buttonSize.width,
                                        buttonSize.height);
    ...
    self.eraseButton.frame = CGRectMake(viewSize.width - buttonSize.width - 10,
                                        viewSize.height - buttonSize.height - 50,
                                        buttonSize.width,
                                        buttonSize.height);
    ...
    self.reloadButton.frame = CGRectMake(viewSize.width - buttonSize.width- 10,
                                         viewSize.height - buttonSize.height - 5,
                                         buttonSize.width,
                                         buttonSize.height);
